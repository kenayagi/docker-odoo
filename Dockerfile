...
CMD /opt/odoo/core/odoo-bin --workers 2 --data-dir=/srv/odoo --config=/srv/odoo.conf --db_host=$POSTGRES_HOST --db_user=$POSTGRES_USER --db_password=$POSTGRES_PASSWORD --proxy-mode --addons-path=/opt/odoo/core/addons,/opt/odoo/extra/l10n-italy,/opt/odoo/extra/partner-contact,/opt/odoo/extra/account-financial-tools,/opt/odoo/extra/server-tools,/opt/odoo/extra/reporting-engine,/opt/odoo/extra/account-payment,/opt/odoo/extra/stock-logistics-workflow
